...
\begin{document}
  ...
  \begingroup
    ...
    % \input{FrontBackMatter/Dedication} % Dedication page
    % \input{FrontBackMatter/Acknowledgments} % Acknowledgements page
    % \input{FrontBackMatter/Declaration} % Declaration
    % \input{FrontBackMatter/Abstract} % Abstract page
  \endgroup
  %---------------------------------------------------
  ...
  \input{Chapters/optimisation}
  \input{Chapters/bkgest}
